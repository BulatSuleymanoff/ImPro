...
double SobelFilter::Formula(int x, int y)
{
	return 0;
}

double SobelFilter::SeparableFormula(int x)
{
	return 0;
}

void SobelFilter::NoBoarderConvolution()
{
	int gx, gy, sum;
...
void SobelFilter::SeparableConvolution()
{
	int gx, gy, sum, y1, x1;
